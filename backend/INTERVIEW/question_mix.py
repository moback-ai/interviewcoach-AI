...
Used by question_generation.generate_core_questions for type x difficulty planning.
...
def allocate_type_counts_by_difficulty_targets(
    type_counts: Mapping[str, int],
    beginner_count: int,
    medium_count: int,
    hard_count: int,
    ...
    """
    Build a type x difficulty integer matrix that preserves both margins.
